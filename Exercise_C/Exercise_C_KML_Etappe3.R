...
extract_placemark_details <- function(placemark) {
  ...
  # Für jeden Punkt Start- und Endzeit übernehmen
  data.frame(Placemark = name, Longitude = longitudes, Latitude = latitudes, Start_Time = start_times, End_Time = end_times)
}
